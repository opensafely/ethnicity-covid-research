...
file open tablecontent using $Tabfigdir/table6_infected_eth5.txt, write text replace
...
outsheet using "$Tabfigdir/FP_infected_eth5.txt", replace

insheet using $Tabfigdir/table6_infected_eth5.txt, clear
