/*==============================================================================
DO FILE NAME:			06e_eth_sensanalysis_underlyingcovid_eth5
...
cap log close
macro drop hr
log using ./logs/06e_sens_onsunderlyingdeath_eth5.log, replace t 

cap file close tablecontent
file open tablecontent using ./output/sens_onsunderlyingdeath_eth5.txt, write text replace
file write tablecontent ("Table 2: Association between ethnicity in 5 categories and underlying COVID-19 death") _n
...
eststo model1
parmest, label eform format(estimate p lb ub) saving(./output/crude_onsunderlyingdeath_eth5, replace) idstr("crude_onsunderlyingdeath_eth5") 
...
parmest, label eform format(estimate p lb ub) saving(./output/model0_onsunderlyingdeath_eth5, replace) idstr("model0_onsunderlyingdeath_eth5")
...
parmest, label eform format(estimate p lb ub) saving(./output/model1_onsunderlyingdeath_eth5, replace) idstr("model1_onsunderlyingdeath_eth5") 
...
parmest, label eform format(estimate p lb ub) saving(./output/model2_onsunderlyingdeath_eth5, replace) idstr("model2_onsunderlyingdeath_eth5") 
...
parmest, label eform format(estimate p lb ub) saving(./output/model3_onsunderlyingdeath_eth5, replace) idstr("model3_onsunderlyingdeath_eth5") 
...
forvalues eth=2/6 {
	...
	local denominator = r(N)
	qui safecount if eth5 == `eth' & onsunderlyingdeath == 1
	local event = r(N)
	...
	cap estimates use ./output/crude_onsunderlyingdeath_eth5 
	 cap lincom `eth'.eth5, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model0_onsunderlyingdeath_eth5 
	 cap lincom `eth'.eth5, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model1_onsunderlyingdeath_eth5 
	 cap lincom `eth'.eth5, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model2_onsunderlyingdeath_eth5 
	 cap lincom `eth'.eth5, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model3_onsunderlyingdeath_eth5 
	 cap lincom `eth'.eth5, eform
