/*==============================================================================
DO FILE NAME:			06a_eth_an_multivariable_eth5_carehomesonly
...
cap log close
macro drop hr
log using "$Logdir/06a_eth_an_multivariable_eth5_carehomesonly", replace t 

cap file close tablecontent
file open tablecontent using $Tabfigdir/table2_eth5_carehomesonly.txt, write text replace
...
/* Estout================================================================*/ 
cap esttab model1 model2 model3 model4 using "$Tabfigdir/estout_table2_eth5_carehomesonly.txt", b(a2) ci(2) label wide compress eform ///
	title ("`i'") ///
	varlabels(`e(labels)') ///
	stats(N_sub) ///
	append 
...
outsheet using "$Tabfigdir/FP_multivariable_eth5_carehomesonly.txt", replace

* Close log file 
log close

insheet using $Tabfigdir/table2_eth5_carehomesonly.txt, clear
insheet using $Tabfigdir/estout_table2_eth5_carehomesonly.txt, clear
