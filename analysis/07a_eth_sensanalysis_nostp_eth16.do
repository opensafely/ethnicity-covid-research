...
file open tablecontent using $Tabfigdir/table2_eth16_nostp.txt, write text replace
...
*Age and gender
stcox i.ethnicity_16 i.male age1 age2 age3, nolog
...
/* Estout================================================================*/ 
esttab model1 model2 model3 model4 model5 using "$Tabfigdir/estout_table2_eth16_nostp.txt", b(a2) ci(2) label wide compress eform ///
	title ("`i'") ///
	varlabels(`e(labels)') ///
	stats(N_sub) ///
	append 
...
outsheet using "$Tabfigdir/FP_multivariable_eth16_nostp.txt", replace

* Close log file 
log close

insheet using $Tabfigdir/table2_eth16_nostp.txt, clear
insheet using $Tabfigdir/estout_table2_eth16_nostp.txt, clear
