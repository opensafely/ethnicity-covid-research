/*==============================================================================
DO FILE NAME:			05b_eth_table1_descriptives_eth5_carehomesonlys
...
* Open a log file
capture log close
log using "$Logdir/05b_eth_table1_descriptives_eth5_carehomesonly", replace t
...
file open tablecontent using $Tabfigdir/table1_eth5_carehomesonly.txt, write text replace
...
clear
insheet using "$Tabfigdir/table1_eth5_carehomesonly.txt", clear
