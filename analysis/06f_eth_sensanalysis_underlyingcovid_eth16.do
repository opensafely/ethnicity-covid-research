/*==============================================================================
DO FILE NAME:			06f_eth_sensanalysis_underlyingcovid_eth16
...
cap log close
macro drop hr
log using ./logs/06f_sens_onsunderlyingdeath_eth16.log, replace t 

cap file close tablecontent
file open tablecontent using ./output/sens_onsunderlyingdeath_eth16.txt, write text replace
file write tablecontent ("Table 2: Association between ethnicity in 16 categories and underlying COVID-19 death") _n
...
eststo model1
parmest, label eform format(estimate p lb ub) saving(./output/crude_onsunderlyingdeath_eth16, replace) idstr("crude_onsunderlyingdeath_eth16") 
...
parmest, label eform format(estimate p lb ub) saving(./output/model0_onsunderlyingdeath_eth16, replace) idstr("model0_onsunderlyingdeath_eth16")
...
parmest, label eform format(estimate p lb ub) saving(./output/model1_onsunderlyingdeath_eth16, replace) idstr("model1_onsunderlyingdeath_eth16") 
...
parmest, label eform format(estimate p lb ub) saving(./output/model2_onsunderlyingdeath_eth16, replace) idstr("model2_onsunderlyingdeath_eth16") 
...
parmest, label eform format(estimate p lb ub) saving(./output/model3_onsunderlyingdeath_eth16, replace) idstr("model3_onsunderlyingdeath_eth16") 
local hr "`hr' ./output/model3_onsunderlyingdeath_eth16 "



/* Estout================================================================*/ 
esttab model1 model2 model3 model4 model5 using ./output/estout_onsunderlyingdeath_eth16.txt, b(a2) ci(2) label wide compress eform ///
...
forvalues eth=2/17 {
	...
	local denominator = r(N)
	qui safecount if ethnicity_16 == `eth' & onsunderlyingdeath == 1
	local event = r(N)
	...
	cap estimates use ./output/crude_onsunderlyingdeath_eth16 
	 cap lincom `eth'.ethnicity_16, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model0_onsunderlyingdeath_eth16 
	 cap lincom `eth'.ethnicity_16, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model1_onsunderlyingdeath_eth16 
	 cap lincom `eth'.ethnicity_16, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model2_onsunderlyingdeath_eth16 
	 cap lincom `eth'.ethnicity_16, eform
	file write tablecontent  %4.2f (r(estimate)) _tab ("(") %4.2f (r(lb)) (" - ") %4.2f (r(ub)) (")") _tab 
	cap estimates clear
	cap estimates use ./output/model3_onsunderlyingdeath_eth16 
	 cap lincom `eth'.ethnicity_16, eform
