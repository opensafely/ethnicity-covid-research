/*==============================================================================
DO FILE NAME:			05a_eth_table1_descriptives_eth16_carehomesonly
...
* Open a log file
capture log close
log using "$Logdir/05a_eth_table1_descriptives_eth16_carehomesonly", replace t
...
file open tablecontent using $Tabfigdir/table1_eth16_carehomesonly.txt, write text replace
...
clear
insheet using "$Tabfigdir/table1_eth16_carehomesonly.txt", clear
